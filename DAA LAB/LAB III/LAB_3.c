...
void strassenMultiply(int** A, int** B, int** C, int n) {
    ...
    // Allocate sub-matrices and temporary matrices
    ...
    int** P1 = allocateMatrix(newSize); int** P2 = allocateMatrix(newSize);
    int** P3 = allocateMatrix(newSize); int** P4 = allocateMatrix(newSize);
    int** P5 = allocateMatrix(newSize); int** P6 = allocateMatrix(newSize);
    int** P7 = allocateMatrix(newSize);

    int** tempA = allocateMatrix(newSize); int** tempB = allocateMatrix(newSize);
    ...
    // Calculate P1 to P7
    addMatrix(A11, A22, tempA, newSize); addMatrix(B11, B22, tempB, newSize);
